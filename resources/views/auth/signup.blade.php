            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="/signup">
                        ...
                        <div class="input-group mb-3">
                            <input class="form-control" type="password" placeholder="Retype Password" name="passwordRepeat"/>
                        </div>
                        <div class="input-group mb-3">
                            <select class="form-control" name="type">
                                <option value="customer">Customer</option>
                                <option value="outlet-owner">Outlet Owner</option>
                            </select>
                        </div>
                        <div class="input-group mb-3">
                            <input class="form-control btn-success" type="submit" value="Sign Up" name="submit"/>
                        </div>
                        <div class="input-group mb-3">
                            <a href="/login" class="form-control btn-warning text-center text-decoration-none">Sign In</a>
                        </div>
                        {{--<?php--}}
                        {{--if (!empty($success)) { ?>--}}
